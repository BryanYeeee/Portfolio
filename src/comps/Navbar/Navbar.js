...
const Navbar = () => {
    return (
        <div className="lg:fixed lg:top-0 w-full lg:flex justify-between h-60 lg:h-20 xl:px-24 px-10 py-2 bg-slate-700 duration-700">
            <div className="h-10 flex justify-between items-center w-full lg:w-1/3 text-slate-200 duration-700">
